<script src="https://github.com/facebook/facebook-php-sdk/blob/master/src/fb_ca_chain_bundle.crt" type="text/javascript"></script>
<?php
/**
 ...
 * under the License.
 */
 //include 'fb_ca_chain_bundle.crt';
