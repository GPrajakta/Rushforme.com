...
//echo "<script>alert('".$emailid.$password."');</script>";
...
<div class="container">
	<div class="row">
		...
		<!--p style="color:white"><strong>Site is still under construction, please call @9000500600</strong></p-->
...
value=""  id="txtDestinationAddress"/>
						...
						<!--p align="center">Within 2 Hours..</p-->
                    </div>
	...
	<br>
	<strong><p class="typewrite" style="text-align: -webkit-center;" data-period="200" data-type='[ "Services Available In Hyderabad Only", "Services Available In Hyderabad Only", "Services Available In Hyderabad Only", "Services Available In Hyderabad Only" ]'>
