...
//$tamount=String.format("%.2f",$tamount);		
	 ...
	 $waa=$ode['waitingtime']*50;
	$tota=$waa+$tamount+$ser+$ode['itemprice'];
	$tota= round($tota);
	$_SESSION['amount']=$tota;
 $addtot=mysql_query("update orderdetails set totalprice='$tota' where id='$odid'")
		?>
<tr>
<td width="25%"><b>Name :</b></td>
<td width="25%"><?php echo $_SESSION['username'] ?></td>
<td width="25%"><b>Mobile No :</b></td>
<td width="25%"><?php echo $_SESSION['mobileno']; ?></td>
</tr>
<tr> 
<td><b>From :</b></td>
<td colspan="3"><?php echo $ode['pickupaddress'];?></td>
</tr>
<tr> 
<td><b>TO :</b></td>
<td colspan="3"><?php echo $ode['destination'];?></td>
</tr>
<tr> 
<td><b>Vehicle Type :</b></td>
<td colspan="3"><?php echo $pkmv['vehicletype']."Wheeler";?></td>
</tr>
<tr> 
<td><b>Total Estimated Time :</b></td>
...
<td colspan="3"><?php echo $waa; ?></td>
</tr> 
<tr> 
<td><b>Item price :</b></td>
<td colspan="3"><i class="fa fa-inr"></i> <?php if($ode['itemprice']=='') echo '0'; else echo $ode['itemprice']; ?></td>
</tr>                                             
<tr> 
<td><b>Total Amount :</b></td>
<td><i class="fa fa-inr"></i> <?php echo $tota."\n(Item Cost + Service Cost + Tax + Waiting Time )"; ?></td>
<td><b>Item weight :</b></td>
<td><?php echo $ode['itemWeight'];?> Grams</td>
</tr> 
...
<div class="modal " id="table-modal" tabindex="-1" role="dialog"
 ...
 $dsm=$dr*$de;
				...
				?>
								...
								<td class=" " style="color:red;font-size:12px;"><?php echo $_SESSION["ffrom"];?>.  <br> 
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; to &nbsp;&nbsp; <br> <?php echo $_SESSION["fto"] ;?></td>
                                <td class=" ">wheeler </td>
